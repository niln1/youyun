...
import CyTrailGrid = require("../ui/grid/cy-trail-grid");
...
$(document).ready(() => {
    ...
    $.i18n.init(option, () => {
        ...
        CyTemplates.loadTemplate("frames/framed-trail-grid.html", function () {
            ...
            g.toolbar = new CyGridComboToolbar('trail-grid', ['filter', 'copy-to-clipboard', 'show-affected-services']);
