...
import CyLinkGrid = require("../ui/grid/cy-link-grid");
...
$(document).ready(() => {
    ...
    $.i18n.init(option, () => {
        ...
        CyTemplates.loadTemplate("frames/framed-link-grid.html", function () {
            ...
            g.toolbar = new CyGridComboToolbar('link-grid', ['filter', 'copy-to-clipboard', 'show-affected-services']);
