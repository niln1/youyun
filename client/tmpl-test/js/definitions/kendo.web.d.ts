...
declare module kendo.mobile {
    ...
    class Application extends Observable {
        ...
        // Commented out by Blake in accordance with recomendation from Telerik (see Ticket: 724415)
        // The Telerik admin states that in a future version of KendoUI these will be removed.
...
declare module kendo.ui {
    ...
    interface GridOptions {
        ...
        toolbar?: any;                          // this can be a string in addition to...GridToolbarItem[];
    ...
    class Splitter extends kendo.ui.Widget {
        ...
        append(object?: any) : SplitterPane;
        insertBefore(object?: any, pane?: any) : SplitterPane;
        insertAfter(object?: any, pane?: any) : SplitterPane;
        remove(pane: any) : void;
        trigger(msg:string, args?:any) : boolean;
        _removeSplitBars() : void;
    }
    ...
    class TreeView extends kendo.ui.Widget {
        ...
        dataSource: kendo.data.DataSource;
        append(nodeData: any, parentNode?: JQuery): JQuery;
        ...
        text(node: any, newText: string): string;
